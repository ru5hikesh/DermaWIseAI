    ...
    <nav className="bg-gray-900 py-2 px-5 fixed top-0 left-0 w-full shadow-md z-50">
      <div className="max-w-6xl mx-auto flex justify-between items-center">
        <ul className="flex gap-5 m-0 p-0 list-none">
          <li><a href="home" className="text-white text-base font-medium px-4 py-2 rounded-md transition duration-300 hover:bg-gray-600 hover:text-gray-200">Home</a></li>
